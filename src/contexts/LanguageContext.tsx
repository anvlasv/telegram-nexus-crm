...
const translations = {
  ru: {
    ...
    // Enhanced post form translations
    'create-post': 'Создать пост',
    'edit-post': 'Редактировать пост',
    'schedule': 'Запланировать',
    'post-content-placeholder': 'Введите текст поста...',
    'attach-media': 'Прикрепить медиа',
    'poll-question': 'Вопрос опроса',
    'poll-question-placeholder': 'Введите вопрос опроса',
    'poll-option-placeholder': 'Вариант ответа',
    'add-poll-option': 'Добавить вариант',
    'remove-option': 'Удалить',
    'characters-left': 'символов осталось',
    'text-limit': 'Лимит для текста',
    'caption-limit': 'Лимит для подписи',
    'media-caption': 'Подпись к медиа',
    'media-caption-placeholder': 'Добавить подпись...',
    'post-preview': 'Предварительный просмотр поста',
    'scheduled-for': 'Запланировано на',
    'will-be-published-at': 'Будет опубликовано',
    'drag-drop-files': 'Перетащите файлы сюда или нажмите для выбора',
  ...
  en: {
    ...
    'poll-question-placeholder': 'Enter poll question',
    'poll-option-placeholder': 'Answer option',
    ...
    'media-caption-placeholder': 'Add caption...',
    'post-preview': 'Post Preview',
    'scheduled-for': 'Scheduled for',
    'will-be-published-at': 'Will be published at',
    'drag-drop-files': 'Drag files here or click to select',
