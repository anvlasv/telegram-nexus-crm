...
const translations = {
  ru: {
    ...
    'posts-for-selected-date': 'Посты на выбранную дату',
    'no-posts-for-date': 'Нет постов на эту дату',
  ...
  en: {
    ...
    'this-week': 'This Week',
    'next-week': 'Next Week',
    'posts-for-selected-date': 'Posts for selected date',
    'no-posts-for-date': 'No posts for this date',
