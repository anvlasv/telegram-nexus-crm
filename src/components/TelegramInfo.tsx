...
export const TelegramInfo: React.FC = () => {
  ...
  if (!isInTelegram) {
    return (
      <Card className="p-6 border-orange-200 bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-orange-950 dark:to-yellow-950">
  ...
  return (
    <div className="space-y-4">
      {/* Статус подключения */}
      <Card className="p-6 border-green-200 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950 dark:to-emerald-950">
        ...
        {user && (
          <div className="space-y-3 p-4 bg-white/50 dark:bg-gray-800/50 rounded-lg">
            <div className="flex items-center space-x-3">
      ...
      <Card className="p-6">
        <h4 className="font-medium mb-4 flex items-center space-x-2">
          ...
          <span>Информация о платформе</span>
        </h4>
        ...
        <div className="grid grid-cols-2 gap-4 text-sm">
          <div className="space-y-2">
            <div className="flex justify-between">
              ...
              <span className="font-medium">{webApp?.platform}</span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Версия API:</span>
              <span className="font-medium">{webApp?.version}</span>
            </div>
          </div>
          <div className="space-y-2">
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center space-x-1">
                ...
                <span className="font-medium capitalize">{webApp?.colorScheme}</span>
              </div>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-600 dark:text-gray-400">Высота:</span>
              <span className="font-medium">{webApp?.viewportHeight}px</span>
            </div>
          </div>
        </div>
      </Card>
      ...
      <Card className="p-6">
        <h4 className="font-medium mb-4">🧪 Тестирование функций</h4>
      ...
      <Card className="p-6 bg-blue-50 dark:bg-blue-950 border-blue-200 dark:border-blue-800">
        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="pt-2 border-t border-blue-200 dark:border-blue-700">
            ...
            <code className="text-xs bg-blue-100 dark:bg-blue-900 px-2 py-1 rounded block mt-1 break-all">
